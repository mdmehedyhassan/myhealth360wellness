...
// className=" flex flex-col justify-center items-center bg-no-repeat bg-cover bg-center"
// style={{
//   backgroundImage: `url("https://i.ibb.co.com/hLstWXt/theraaapy-book-img.png")`,
// }}
