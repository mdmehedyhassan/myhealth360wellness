            ...
            <div className="overflow-hidden mx-4 w-full">
              ...
              >
                {services.map((service, index) => (
                  <div
                    key={index}
                    className={`flex-none w-full ${itemsPerSlide === 3
                      ? "lg:w-1/3"
                      : itemsPerSlide === 2
                        ? "sm:w-1/2"
                        : "w-full"
                  ...
                  >
                    <div className="relative rounded-lg overflow-hidden p-2 lg:p-4 bg-white">
                      <Iframe
                        url={service.map}
                        id=""
                        className="rounded-lg w-[255px] lg:w-[340px] h-[253px] lg:h-[327px]"
                        display="block"
                        position="relative"
                      />
