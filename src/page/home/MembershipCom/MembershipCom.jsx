...
const MembershipCom = () => {
  return (
    <div className="px-5 lg:px-20 bg-[#D9E5DE] w-full rounded-xl mx-5 mt-32 mb-64">
      <div className="grid gap-10 lg:gap-20 max-w-7xl mx-auto">
        
        {/* Card 1 */}
        <div className="bg-white rounded-xl shadow-lg p-6 lg:p-10 flex flex-col lg:flex-row justify-between items-center -mt-32 ">
          <div className="lg:w-1/2 lg:pr-10">
            <h3 className="text-lg leading-[150%] font-semibold text-[#0B5E62] mb-2">Memberships</h3>
            <h2 className="text-5xl leading-[120%] font-bold text-[#062223] mb-4">Medical Spa Membership</h2>
          ...
          <div className="lg:w-1/2 mt-5 lg:mt-0 max-w-[456px]">
            <img 
              src={medicalspaImg} 
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 lg:p-10 flex justify-between flex-col lg:flex-row items-center -mb-32">
          <div className="lg:w-1/2 lg:pr-10 order-2 lg:order-1">
            <h3 className="text-lg leading-[150%] font-semibold text-[#0B5E62] mb-2">Memberships</h3>
            <h2 className="text-5xl leading-[120%] font-bold text-[#062223] mb-4">Medical Gym and Rehab</h2>
