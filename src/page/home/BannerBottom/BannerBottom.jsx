...
const BannerBottom = () => {
  return (
    <div className="flex bg-primary flex-col md:flex-row justify-center items-center py-6 px-5 md:px-0 mt-[-6px] rounded-b-lg">
      <div>
        <p className="lg:ml-10 md:max-w-[596px] text-white text-[10px] lg:text-base font-medium leading-[160%] md:border-r-2 md:border-borderSecondary pr-0 md:pr-20 mb-3 lg:mb-0 md:mb-0">
      ...
      <div className="flex gap-2 lg:gap-6 md:gap-10 mr-0 md:mr-10 ml-0 md:ml-28">
        {/* phone */}
