...
const BannerBottom = () => {
  return (
    <div className="flex bg-primary flex-col md:flex-row justify-center items-center py-6 px-5 md:px-0">
      <div>
        <p className="ml-10 md:max-w-[596px] text-white text-base font-medium leading-[160%]  md:border-r-2 md:border-[#95DDD947] pr-0 md:pr-20 mb-8 md:mb-0">
      ...
      <div className="flex gap-6 md:gap-10 mr-0 md:mr-10 ml-0 md:ml-28 mb-5 md:mb-0">
        ...
        <div className="flex gap-3 border-[1px] border-[#95DDD947] rounded-[10px] pt-2 md:pt-[10px] pb-2 md:pb-3 pl-2 md:pl-[11px] pr-2 md:pr-5">
          ...
          <div>
            <h4 className="text-[#AAC6C0] text-[11px] md:text-sm font-medium leading-[150%]">
              Call us
            </h4>
