  ...
  return (
    <div className="py-5 lg:py-10 pb-16 lg:pb-32 bg-[#D9E5DE] rounded-xl w-full">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center text-start ">
        <div className="flex">
          <div className="lg:bg-[#fff] p-5 grid grid-cols-3 lg:grid-cols-1 lg:border-2 border-[#0B5E62] rounded-lg lg:gap-5 gap-x-2 gap-y-2 ">
            {options.map((option) => (
              <button
                key={option.title}
        ...
        <div className="flex flex-col-reverse lg:flex-row bg-[#fff] border-2 border-[#0B5E62] rounded-lg  px-5 max-w-[1027px] mx-5">
